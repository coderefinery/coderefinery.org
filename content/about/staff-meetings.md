...
- [ ] From ["Workflow to make CR lessons citable via Zenodo"](https://hackmd.io/pr3hps9SRgWwSPOHWRMWXA?view#Workflow-to-make-CR-lessons-citable-via-Zenodo)
    ...
    - [ ] [JH] Making sure the 3 categories we defined still then map to CITATION.cff 
    - [ ] [JH] Create a demo on a fork+sandbox where this is demonstrated for one lesson 
...
- [ ] [DI, ME] Workshop, 2021 May - retrospective, document prepared and link shared
    ...
    - [ ] document tasks what other persons can contribute so that we can move it further
