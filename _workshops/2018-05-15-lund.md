...
helpers:
    - TBA
location: |
          Room "Brunnen" in the <a href="www.studiecentrum.lth.se">Studiecentrum</a>, Lund University.   

          NOTE: Participants traveling by plane to Lund are recommended to fly to Kastrup, Copenhagen, and take the train from there to Lund.
schedule:
    - date: Tuesday, May 15
      software:
        - title: Bash
