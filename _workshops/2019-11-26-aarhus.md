...
location: 
    The event is organized at Aarhus University but is open to everyone.
    The location is the in building 5361 room 144, also referred to as Agora Videolink. The room is on the same level as the entrance. The full address of venue is 
  ...
  Find a google maps pin to the building here: http://tiny.cc/CRAU19. Alternatively, you can install 
  [an app](https://play.google.com/store/apps/details?id=com.au.aufind) for navigating Aarhus University's buildings. 
